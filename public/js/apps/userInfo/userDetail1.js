...
function buy_history(){
 ...
 var tableColumns = [
      ...
      /* {width:150,field: 'imei', title: '操作人', align : 'center',valign : 'middle',},*/
       ...
       {width:150,field: 'phone_count', title: '数量', align : 'center',valign : 'middle',},
     ...
     /*   {width:150,field: 'Button', title: '操作', events: btn_events_his,formatter:AddEventBtn_his},*/
      ...
      function responseHandler(info) {
        ...
        if(info.data.info){
          ...
          $.each(info.data.info.list,function(i,v){
            ...
            v.start_date_t = v.due_date == null ? '' :parent.UnixToDateTime(v.due_date)
            v.end_date_t = parent.UnixToDateTime(v.addtime)
      ...
      var detail = {
            ...
            "api" :   parent.DmConf.api.new.Customer_Log,
