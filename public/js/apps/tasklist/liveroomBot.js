...
// '<button id="check_res"  type="button" class="btn" >详情</button> '

function AddEventBtn(a, value, c) {// 0未运行,1运行中，2结束，3错误，4中断，5手动结束
  var arr = ['<button id="delMission"  type="button" class="btn" >删除</button> ', ];
...
function search_init() {
  ...
  var tableColumns = [
    ...
    { width: 170, field: 'time_tick_name', title: '任务执行时间', align: 'center', valign: 'middle', },
